        ...
        <nav class="navbar navbar-expand-lg al-header-section bg-white" :class="[{ 'al-header-active': isActive }]">
          ...
          /> -->
                ...
                <div class="branch-dropdown d-none d-xl-block">
                    <ClientOnly>
                        <a-cascader v-if="branchOptions.length > 0" :value="value" :options="branchOptions"
                            expand-trigger="hover" placeholder="Vui lòng chọn" popupClassName="custom-dropdown"
                            :dropdownStyle="{
                                maxHeight: 'unset',
                                overflow: 'visible',
                                height: 'auto',
                            ...
                            @change="handleChangeCinema" :allowClear="false" />
                    </ClientOnly>
                </div>
