  ...
  >
    ...
    <div class="container py-5">
      ...
      <div class="text-center mb-5">
        <img
          v-if="siteInfo.privacy_policy_image"
          class="content-img img-fluid shadow-lg rounded-4 border border-primary"
          :alt="siteInfo.name"
          :src="formattedImage(siteInfo.privacy_policy_image)"
        />
      ...
      <section class="p-5 shadow-lg rounded-4 content-card">
        <h2 class="text-white fw-semibold mb-3">🌟 Chính Sách bảo mật </h2>
        <div class="text-light fs-5" v-html="siteInfo.privacy_policy"></div>
      </section>
    </div>
  </div>
